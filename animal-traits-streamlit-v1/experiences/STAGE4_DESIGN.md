...
| Using and trusting a model | 10 | Predict when the answer is unknown | Placeholder for the later no-answer-key prediction design, where learners will choose a defensible model and judge confidence without an answer to reveal. |
| Using and trusting a model | 11 | Data Science | Consolidate the evidence-to-model process and model limits. |
