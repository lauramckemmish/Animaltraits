...
| Seeing structure in data | 2 | Find your animals | Search the real dataset and distinguish species absent from it, species present but incomplete for the comparison, and graph-ready species with both body-mass and brain-mass evidence. Learners carry forward four or five scientific-name identities; Stage 4 does not require exactly three searches. |
