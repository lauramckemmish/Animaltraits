...
| Seeing structure in data | 2 | Find your animals | Search the real dataset and distinguish species absent from it, species present but incomplete for the comparison, and graph-ready species with both body-mass and brain-mass evidence. Learners carry forward four to eight scientific-name identities; Stage 4 does not require exactly three searches. |
...
| Using and trusting a model | 6 | Mammal model | Treat the fitted relationship as an evidence-grounded summary, not an exact rule or causal law. |
| Using and trusting a model | 7 | Test the model: cat | Predict, compare separate evidence, then encounter interpolation. |
